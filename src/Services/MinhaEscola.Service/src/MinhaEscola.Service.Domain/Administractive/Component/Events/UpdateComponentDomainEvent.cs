...
{
    public class UpdateComponentDomainEvent : IEvent
    {
        public UpdateComponentDomainEvent()
        {

        }

        public UpdateComponentDomainEvent(string name, long denomination, TypeOrganization typeOrganization, long stageId, long modalityId)
        {
            Name = name;
